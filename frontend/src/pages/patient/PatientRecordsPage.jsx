        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-5 w-full lg:w-auto">
           <div className="flex flex-col items-start lg:items-end mr-2">
            ...
            <Button 
              ...
              className="bg-blue-600 hover:bg-blue-700 h-14 px-10 rounded-[1.5rem] font-bold uppercase tracking-widest text-[11px] flex items-center justify-center gap-3 shadow-xl shadow-blue-100 transition-all hover:scale-105 w-full sm:w-auto"
            >
            ...
            <div className="p-6 border-b border-gray-50 flex items-center justify-between px-10 bg-white">
               <div className="relative w-full max-w-md">
                  ...
                  <Input 
                     ...
                     className="pl-12 bg-gray-50/50 border-gray-100 h-12 rounded-2xl focus-visible:ring-1 font-black text-sm text-black"
                     value={searchQuery}
                ...
                <Table className="min-w-[800px] md:min-w-0">
                   <TableHeader className="bg-gray-50/20">
                     <TableRow className="hover:bg-transparent border-gray-50 h-14">
                       <TableHead className="w-[140px] text-[10px] font-black text-black uppercase tracking-widest pl-10">DATE</TableHead>
                       <TableHead className="text-[10px] font-black text-black uppercase tracking-widest">DIAGNOSIS / REASON</TableHead>
                       <TableHead className="text-[10px] font-black text-black uppercase tracking-widest">MEDICINES</TableHead>
                       <TableHead className="text-[10px] font-black text-black uppercase tracking-widest text-right pr-10">STATUS</TableHead>
                     </TableRow>
                   </TableHeader>
               <TableBody>
                 ...
                 {filteredVisits.length === 0 && (
                   <TableRow>
                     <TableCell colSpan={4} className="text-center text-black font-black py-32 flex flex-col items-center gap-4">
            ...
            {selectedVisit && (
               <div className="flex flex-col h-full bg-white">
                  <div className="flex items-center justify-between p-10 border-b pb-8 bg-white sticky top-0 z-10">
                     <div>
                        <SheetTitle className="text-2xl font-black tracking-tight text-black">Clinical History</SheetTitle>
                        <p className="text-[10px] font-black text-black uppercase tracking-[0.3em] mt-2">Appointment Identity: #{selectedVisit.id?.slice(-8).toUpperCase()}</p>
                     </div>
                  ...
                  <div className="p-10 space-y-12 pb-32">
                     <div>
                        <h4 className="text-[10px] font-black uppercase text-black tracking-[0.4em] mb-6 ml-1">Vitals Summary</h4>
                        {selectedVisit.vitals ? (
                           ...
                           <div className="text-[10px] font-black text-black uppercase italic p-10 bg-gray-50/50 rounded-[3rem] border border-dashed border-gray-200 text-center tracking-widest leading-loose">No vitals were recorded for this session.</div>
                        )}
                     </div>

                     <div className="space-y-8">
                        <div className="relative">
                           <div className="text-[10px] font-black uppercase text-black tracking-[0.4em] mb-4 ml-1">Initial Complaint</div>
                           <div className="text-[13px] font-black text-black bg-gray-50/50 p-8 rounded-[2.5rem] border border-gray-50 leading-relaxed shadow-inner">{selectedVisit.notes || "-"}</div>
                        </div>
                     ...
                     {selectedVisit.consultation?.prescription?.items && selectedVisit.consultation.prescription.items.length > 0 && (
                        <div>
                           <h4 className="text-[10px] font-black uppercase text-black tracking-[0.4em] mb-6 ml-1">Meds Prescribed</h4>
                           <div className="border border-gray-100 rounded-[2.5rem] overflow-hidden shadow-sm bg-white">
                              <Table>
                                 <TableHeader className="bg-gray-50/50">
                                    <TableRow className="hover:bg-transparent border-gray-50">
                                       <TableHead className="text-[9px] font-black text-black uppercase tracking-widest pl-10 h-12">Medicine</TableHead>
                                       <TableHead className="text-[9px] font-black text-black uppercase tracking-widest">Dosage</TableHead>
                                       <TableHead className="text-[9px] font-black text-black uppercase tracking-widest text-center pr-10">Timing</TableHead>
                                    </TableRow>
                                 </TableHeader>
                                 <TableBody>
                                    {selectedVisit.consultation.prescription.items.map((m, idx) => (
                                       <TableRow key={idx} className="border-gray-50 bg-white hover:bg-gray-50/30 h-20 transition-all">
                                          ...
                                          <TableCell>
                                             <div className="font-black text-[13px] text-black">{m.dosage || "-"}</div>
                                          </TableCell>
