  ...
  return (
    <div className="flex flex-col items-center justify-start pt-20 h-full max-w-5xl mx-auto px-4">
      <div className="w-full space-y-2 mb-10">
        <h1 className="text-3xl font-bold text-black tracking-tight">Reception Command Center</h1>
      ...
      <div className="w-full relative group">
        <div className="absolute left-6 top-1/2 -translate-y-1/2 text-black group-focus-within:text-blue-500 transition-colors">
           <Search className="w-6 h-6" />
        </div>
        <Input 
          className="h-16 pl-16 rounded-2xl border-gray-200 bg-white shadow-sm text-lg focus:ring-2 focus:ring-blue-100 transition-all placeholder:text-black"
