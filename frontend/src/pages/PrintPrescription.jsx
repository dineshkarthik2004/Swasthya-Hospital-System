      ...
      `}</style>
       ...
       <div id="print-area" className="bg-white text-black p-12 serif w-[210mm] shadow-2xl print:shadow-none mx-auto flex flex-col">
          ...
          <div className="flex-1 flex flex-col space-y-5 h-full">
             ...
             <div className="flex gap-6">
                ...
                <div className="w-[200px]">
                   ...
                   <div className="grid grid-cols-2 gap-2 p-1">
                      ...
                      <div>
                         <p className="text-[8px] text-gray-400 font-bold uppercase">WT</p>
                         <p className="text-xs font-bold">{vitals?.weight || "-"}</p>
                      </div>
                      <div>
                         <p className="text-[8px] text-gray-400 font-bold uppercase">PR</p>
             ...
             {/* Footer - Remarks & Advice */}
             <div className="mt-auto space-y-4 pt-4 border-t-2 border-slate-900/10">
                <div className="grid grid-cols-3 gap-6">
                   ...
                   <div className="flex flex-col items-center justify-center p-3 bg-slate-50/50 border border-slate-100 rounded-xl">
                      <span className="text-[8px] font-black text-slate-300 uppercase tracking-[0.2em] mb-1">Follow up</span>
                      <span className="text-sm font-bold text-slate-900 uppercase">{consultation?.followUpDate ? new Date(consultation.followUpDate).toLocaleDateString("en-US", { day: 'numeric', month: 'short', year: 'numeric' }) : "As Req."}</span>
                   </div>
                </div>
