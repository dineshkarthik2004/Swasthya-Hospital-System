  ...
  return (
    <div className="p-8 space-y-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-black font-bold uppercase tracking-widest text-[11px] opacity-40">Real-time performance metrics across the network.</p>
      </div>
        ...
        {cards.map((card, i) => (
          <div key={i} className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 group">
            ...
            <div className="space-y-1">
              <p className="text-black text-[10px] font-bold uppercase tracking-[0.2em] opacity-40">{card.name}</p>
              <h3 className="text-3xl font-bold text-black tracking-tighter">{loading ? "..." : card.value}</h3>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-white rounded-[3rem] border border-gray-100 p-8 shadow-sm">
           <div className="flex justify-between items-center mb-8">
              <h3 className="text-xl font-black text-black tracking-tight text-black">Network Activity</h3>
